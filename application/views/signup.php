          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="box">
                ...
                <hr>
				<?php $attributes = array('id' => 'signup', 'name'=>'signup', 'autocomplete' => 'off'); echo form_open('ggg/signup', $attributes);?>
                  <div class="form-group">
                    <label for="name-login">Name</label>
                    <input id="name-login" name="Name" type="text" class="form-control">edge
                  </div>
                  <div class="form-group">
