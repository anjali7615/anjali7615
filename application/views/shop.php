          ...
          <div class="row bar">
            ...
            <div class="col-lg-9">
              ...
              <div id="productMain" class="row">
                <div class="col-sm-6">
                  <div data-slider-id="1" class="owl-carousel shop-detail-carousel">
                    <div> <img src="<?php echo base_url();?>assets/img/detailbig1.jpg" alt="" class="img-fluid"></div>
                    <div> <img src="<?php echo base_url();?>assets/img/detailbig2.jpg" alt="" class="img-fluid"></div>
                    <div> <img src="<?php echo base_url();?>assets/img/detailbig3.jpg" alt="" class="img-fluid"></div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="box">
                  ...
                  <div data-slider-id="1" class="owl-thumbs">
                    <button class="owl-thumb-item"><img src="<?php echo base_url();?>assets/img/detailsquare.jpg" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item"><img src="<?php echo base_url();?>assets/img/detailsquare2.jpg" alt="" class="img-fluid"></button>
                    <button class="owl-thumb-item"><img src="<?php echo base_url();?>assets/img/detailsquare3.jpg" alt="" class="img-fluid"></button>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="product">
                    <div class="image"><a href="#"><img src="<?php echo base_url();?>assets/img/product2.jpg" alt="" class="img-fluid image1"></a></div>
                    <div class="text">
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="product">
                    <div class="image"><a href="#"><img src="<?php echo base_url();?>assets/img/product3.jpg" alt="" class="img-fluid image1"></a></div>
                    <div class="text">
                      <h3 class="h5"><a href="shop-detail.html">Fur coat</a></h3>
                      <p class="price">$143</p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                  <div class="product">
                    <div class="image"><a href="#"><img src="<?php echo base_url();?>assets/img/product1.jpg" alt="" class="img-fluid image1"></a></div>
                    <div class="text">
                      <h3 class="h5"><a href="shop-detail.html">Fur coat</a></h3>
                      <p class="price">$143</p>
                    </div>
            ...
            <div class="col-lg-3">
              ...
              <div class="banner"><a href="shop-category.html"><img src="<?php echo base_url();?>assets/img/banner.jpg" alt="sales 2014" class="img-fluid"></a></div>
            </div>
          </div>
        </div>
      </div>
