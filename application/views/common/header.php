...
<html>
  <head>
    ...
    <?= link_tag('assets/vendor/bootstrap/css/bootstrap.min.css');?>
        <!-- Font Awesome CSS-->
    <?= link_tag('assets/vendor/font-awesome/css/font-awesome.min.css');?>

    <!-- Google fonts - Roboto-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto:300,400,700">
    <!-- Bootstrap Select-->
    <?= link_tag('assets/vendor/bootstrap-select/css/bootstrap-select.min.css');?>
    
    <!-- owl carousel-->
    <?= link_tag('assets/vendor/owl.carousel/assets/owl.carousel.css');?>
    <?= link_tag('assets/vendor/owl.carousel/assets/owl.theme.default.css');?>

   
    <!-- theme stylesheet-->
    <?= link_tag('assets/css/style.default.css');?>
          ...
          <div class="row d-flex align-items-center">
            ...
            <div class="col-md-6">
              <div class="d-flex justify-content-md-end justify-content-between">
                ...
                <div class="login"><a href="#" data-toggle="modal" data-target="#login-modal" class="login-btn"><i class="fa fa-sign-in"></i><span class="d-none d-md-inline-block">Sign In</span></a><a href="<?php echo base_url('ggg/signup');?>" class="signup-btn"><i class="fa fa-user"></i><span class="d-none d-md-inline-block">Sign Up</span></a></div>
              ...
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Features<b class="caret"></b></a>
                  <ul class="dropdown-menu megamenu">
                    <li>
                      <div class="row">
                        <div class="col-lg-6"><img src="<?php echo base_url () ;?>assets/img/template-easy-customize.png" alt="" class="img-fluid d-none d-lg-block"></div>
                      ...
                      <div class="row">
                        <div class="col-md-6 col-lg-3">
                          ...
                          <ul class="list-unstyled mb-3">
                            ...
                            <li class="nav-item"><a href="<?php echo base_url ('ggg/application') ;?>" class="nav-link">Option 2: Application</a></li>
                            ...
                            <li class="nav-item"><a href="<?php echo base_url ('ggg/portfolio') ;?>" class="nav-link">Option 5: Portfolio</a></li>
                          </ul>
                          <h5>About</h5>
                          <ul class="list-unstyled mb-3">
                            <li class="nav-item"><a href="about.html" class="nav-link">About us</a></li>
                        ...
                        <div class="col-md-6 col-lg-3">
                          ...
                          <ul class="list-unstyled mb-3">
                            ...
                            <li class="nav-item"><a href="<?php echo base_url('ggg/orders');?>" class="nav-link">Orders history</a></li>
                        ...
                        <div class="col-md-6 col-lg-3">
                          ...
                          <ul class="list-unstyled mb-3">
                            ...
                            <li class="nav-item"><a href="<?php echo base_url('ggg/category');?>" class="nav-link">Category - full width</a></li>
                            <li class="nav-item"><a href="<?php echo base_url('ggg/productdetail');?>" class="nav-link">Product detail</a></li>
                          </ul>
                          <h5>Shop - order process</h5>
                          <ul class="list-unstyled mb-3">
                            <li class="nav-item"><a href="<?php echo base_url('ggg/shop');?>" class="nav-link">Shopping cart</a></li>
                            ...
                            <li class="nav-item"><a href="<?php echo base_url('ggg/checkout');?>" class="nav-link">Checkout - step 3</a></li>
