      ...
      <div class="container index-forward py-5 py-lg-0">
        <div class="row align-items-end">
          <div class="col-lg-7 mb-4 mb-lg-0">
            <div class="media align-items-center"><img class="rounded-circle" src="<?php echo base_url();?>assets/img/tool-detail-thumb.jpg" alt="" width="80">
            ...
            <div class="card border-0 shadow-sm mb-4 mb-lg-5 p-2 p-lg-0">
              <div class="card-body p-lg-5">
                ...
                <div class="rounded overflow-hidden mb-3">
                  <div class="owl-carousel tool-gallery-slider" data-slider-id="1"><a class="d-block" href="img/tool-gallery-1.jpg" data-lightbox="tool-gallery" title="Gallery item 1"><img class="img-fluid" src="<?php echo base_url();?>assets/img/tool-gallery-1.jpg" alt="..."></a><a class="d-block" href="img/tool-gallery-2.jpg" data-lightbox="tool-gallery" title="Gallery item 2"><img class="img-fluid" src="img/tool-gallery-2.jpg" alt="..."></a><a class="d-block" href="img/tool-gallery-3.jpg" data-lightbox="tool-gallery" title="Gallery item 3"><img class="img-fluid" src="img/tool-gallery-3.jpg" alt="..."></a><a class="d-block" href="img/tool-gallery-4.jpg" data-lightbox="tool-gallery" title="Gallery item 4"><img class="img-fluid" src="img/tool-gallery-4.jpg" alt="..."></a></div>
                </div>
                <div class="owl-thumbs row px-2" data-slider-id="1">
                  <div class="owl-thumb-item col-3 px-2"><img class="w-100" src="<?php echo base_url();?>assets/img/tool-gallery-1.jpg" alt="..."></div>
                  <div class="owl-thumb-item col-3 px-2"><img class="w-100" src="<?php echo base_url();?>assets/img/tool-gallery-2.jpg" alt="..."></div>
                  <div class="owl-thumb-item col-3 px-2"><img class="w-100" src="<?php echo base_url();?>assets/img/tool-gallery-3.jpg" alt="..."></div>
                  <div class="owl-thumb-item col-3 px-2"><img class="w-100" src="<?php echo base_url();?>assets/img/tool-gallery-4.jpg" alt="..."></div>
                </div>
              </div>
            </div>
            <!-- Video-->
            ...
            <div class="card border-0 shadow-sm p-2 p-lg-0">
              <div class="card-body p-lg-5">
                ...
                <div class="mb-4">
                      <div class="row mb-3">
                        <div class="col-lg-8">
                          <div class="media align-items-center"><img class="rounded-circle" src="<?php echo base_url();?>assets/img/author-3.png" alt="" width="40">
                ...
                <div class="mb-4">
                      <div class="row mb-3">
                        <div class="col-lg-8">
                          <div class="media align-items-center"><img class="rounded-circle" src="<?php echo base_url();?>assets/img/author-2.png" alt="" width="40">
                            <div class="media-body ml-2">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4">
                <div class="card shadow-sm border-0 reset-anchor d-block hover-transition"><a class="d-block dark-overlay card-img-top overflow-hidden tool-trending" href="#">
                    <div class="tool-thumb rounded-circle" href="#"><img class="img-fluid rounded-circle" src="<?php echo base_url();?>assets/img/tool-thumb-1.png" alt="..." width="40"></div>
                    ...
                    <div class="overlay-content"><img class="img-fluid" src="<?php echo base_url();?>assets/img/tool-bg-1.jpg" alt="..."></div></a>
          ...
          <div class="col-lg-4 mb-4">
                <div class="card shadow-sm border-0 reset-anchor d-block hover-transition"><a class="d-block dark-overlay card-img-top overflow-hidden tool-trending" href="#">
                    <div class="tool-thumb rounded-circle" href="#"><img class="img-fluid rounded-circle" src="<?php echo base_url();?>assets/img/tool-thumb-2.png" alt="..." width="40"></div>
                    <div class="featured-badge" rel="tooltip" data-placement="top" title="Featured"><i class="fas fa-bolt"></i></div>
                    <ul class="list-inline tool-rating mb-0">
                      <li class="list-inline-item m-0"><i class="fas fa-star text-white"></i></li>
                      <li class="list-inline-item m-0"><i class="fas fa-star text-white"></i></li>
                    ...
                    <div class="overlay-content"><img class="img-fluid" src="<?php echo base_url();?>assets/img/tool-bg-2.jpg" alt="..."></div></a>
                  <div class="card-body p-4">
          ...
          <div class="col-lg-4 mb-4">
                <div class="card shadow-sm border-0 reset-anchor d-block hover-transition"><a class="d-block dark-overlay card-img-top overflow-hidden tool-trending" href="#">
                    <div class="tool-thumb rounded-circle" href="#"><img class="img-fluid rounded-circle" src="<?php echo base_url();?>assets/img/tool-thumb-3.png" alt="..." width="40"></div>
                    <div class="featured-badge" rel="tooltip" data-placement="top" title="Featured"><i class="fas fa-bolt"></i></div>
                    <ul class="list-inline tool-rating mb-0">
                      <li class="list-inline-item m-0"><i class="fas fa-star text-white"></i></li>
                      <li class="list-inline-item m-0"><i class="fas fa-star text-white"></i></li>
                    ...
                    <div class="overlay-content"><img class="img-fluid" src="<?php echo base_url();?>assets/img/tool-bg-3.jpg" alt="..."></div></a>
                  <div class="card-body p-4">
