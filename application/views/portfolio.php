        ...
        <div class="container">
          ...
          <section>
            <div class="project owl-carousel">
              <div class="item"><img src="<?php echo base_url();?>assets/img/main-slider1.jpg" alt="" class="img-fluid"></div>
              <div class="item"><img src="<?php echo base_url();?>assets/img/main-slider2.jpg" alt="" class="img-fluid"></div>
              <div class="item"><img src="<?php echo base_url();?>assets/img/main-slider3.jpg" alt="" class="img-fluid"></div>
              <div class="item"><img src="<?php echo base_url();?>assets/img/main-slider4.jpg" alt="" class="img-fluid"></div>
            </div>
          </section>
          <section class="bar">
