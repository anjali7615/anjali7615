      ...
      <section style="background: url('<?php echo base_url () ;?>assets/img/photogrid.jpg') center center repeat; background-size: cover;" class="bar background-white relative-positioned">
        <div class="container">
          <!-- Carousel Start-->
